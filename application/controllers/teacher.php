...
public function index(){
   ...
   ,department.dpm_name,accept_req.ac_status,accept_req.ac_id,company.cpn_name
      FROM accept_req
      ...
      INNER JOIN department on department.dpm_id = class.dpm_id WHERE class.tch_id = $tch_id" ;
